...
class NewHabitController: UIViewController {
    ...
    func testfunc() {
        editedHabit = HabitBiding(title: "fdsafa", goal: "fsdfdsf", startDate: Date(), reminders: Date(), imageID: 1, repetition: [1, 2], calendarHistoryID: "fdsfsdfsdf")
        fillHabitsFields()
    }
    
    func fillHabitsFields() {
        if let editedHabit = editedHabit, let repetitionTextField = repetitionTextField, let startDateTextField = startDateTextField, let remainderTextField = remainderTextField {
    ...
    private func captureUserEntry() -> HabitBiding? {
        ...
        return HabitBiding(title: title, goal: goal, startDate: startDate, reminders: startDate, imageID: 1, repetition: [1, 2], calendarHistoryID: "fsdfsdf")
    }
